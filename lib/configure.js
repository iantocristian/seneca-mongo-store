...
module.exports = function(spec, cb) {
  ...
  // mongodb driver auto-reconnect is enabled by default
  // set autoreconnect to false or 0 to disable
  ...
  var serverOptions = _.extend({
    auto_reconnect: typeof conf.autoreconnect === 'undefined' || conf.autoreconnect === true || conf.autoreconnect > 0
  }, { /* TODO: allow more server options to be specified? */ })
